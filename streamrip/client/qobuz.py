...
class QobuzClient(Client):
    ...
    async def _get_valid_secret(self, secrets: list[str]) -> str:
        # ⚡ Bolt: Use asyncio.as_completed to short-circuit the loop and
        # cancel pending requests as soon as a valid secret is found. This
        # prevents slow-tail latency and reduces unnecessary network I/O.
