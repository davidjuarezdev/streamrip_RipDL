...
class QobuzClient(Client):
    ...
    async def _get_valid_secret(self, secrets: list[str]) -> str:
        # ⚡ Bolt: Short-circuit secret testing using as_completed instead of gather.
        # This prevents slow-tail latency and reduces unnecessary network I/O
        # by returning the first valid secret immediately and cancelling the rest.
